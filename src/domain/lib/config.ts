...
export const MiniMaxLlmUrl = Config.string("MINIMAX_LLM_URL").pipe(
  Config.withDefault("https://api.minimax.io/v1"),
);
export const MiniMaxLlmModel = Config.string("MINIMAX_LLM_MODEL").pipe(
  Config.withDefault("MiniMax-Text-01"),
);
export const MiniMaxLlmTemperature = Config.number(
  "MINIMAX_LLM_TEMPERATURE",
).pipe(Config.withDefault(0.5));

export const MiniMaxTtsUrl = Config.string("MINIMAX_TTS_URL").pipe(
  Config.withDefault("https://api.minimax.io/v1/t2a_v2"),
);
...
export const MiniMaxVoiceId = Config.string("MINIMAX_VOICE_ID").pipe(
  Config.withDefault("English_causual_narrator_vv1"),
);
export const MiniMaxDefaultEmotion = Config.string(
  "MINIMAX_DEFAULT_EMOTION",
).pipe(Config.withDefault("neutral"));
...
export const OutputDir = Config.string("OUTPUT_DIR").pipe(
  Config.withDefault("./outputs"),
);
export const DefaultLang = Config.string("DEFAULT_LANG").pipe(
  Config.withDefault("vi"),
);
export const DefaultAspect = Config.string("DEFAULT_ASPECT").pipe(
  Config.withDefault("9:16"),
);
